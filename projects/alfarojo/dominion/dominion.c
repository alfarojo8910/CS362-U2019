...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case mine:
 mineRefactored( currentPlayer,  choice1, choice2,  state,  handPos); 
...
return 0;
//Assignment 2
//Code deleted from baron case and placed into separate function.
    ...
    case minion:
minionRefactor (currentPlayer, choice1, choice2,  state, handPos);
return 0;
/*
//Assignment 2
//Code deleted from baron case and placed into separate function.
*/		
    ...
    case tribute:
/*
Code moved tributeRefactor function.  Assignment 2.
*/
tributeRefactor(currentPlayer, nextPlayer, tributeRevealedCards, state );
    ...
    case ambassador:
	ambassadorRefactor (currentPlayer, choice1, choice2, state, handPos);
/*Code moved to ambassadorRefactor function for Assignment 2.*/ 
...
//FUNCTION DEFINITIONS-refactored code from cardEffect switch cases
...
else if (choice2)		//discard hand, redraw 4, other players with 5+ cards discard hand and draw 4
{
	...
	for (int i = 0; i < state->numPlayers; i++)
	{
		if (i != currentPlayer)
		{
		//BUG #1.  If other players have more than 5 cards they discard and redraw.
...
//#BUG 1: Loop will never terminate.  Variable i does not increment.
for (int i = 0; i < state->numPlayers; i)
{
	if (i != currentPlayer)
	{
...
//BUG#2:  Loop will never terminate.  Variable j does not increment
for (j = 0; j < choice2; j)
{
	for (int i = 0; i < state->handCount[currentPlayer]; i++)
	{
...
int tributeRefactor (int currentPlayer, int nextPlayer, int tributeRevealedCards[], struct gameState *state)
{
      ...
      for (int i = 0; i <= 2; i ++)
	{
		 ...
		 tributeRevealedCards[i] == great_hall)
		{
			...
			//BUG#2: Next player draws card instead of current player  
...
{
//Bug #1: j is initialized to 0.
int j = 0;  //store card we will trash
...
//discard trashed card
//BUG #2: i is initialized to 1 instead of 0
